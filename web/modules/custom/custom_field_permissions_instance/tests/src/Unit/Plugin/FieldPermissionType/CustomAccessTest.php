 ...
 *
 * @coversDefaultClass \Drupal\field_permissions\Plugin\FieldPermissionType\RoleAccess
 *
...
class CustomAccessTest extends UnitTestCase {
   ...
   *
   * @var \Drupal\field_permissions\Plugin\FieldPermissionType\RoleAccess
   */
  protected $plugin;
  ...
  public function setUp():void {
    ...
    $this->plugin = new RoleAccess([], 'custom', [], $storage->reveal(), $field_permissions->reveal());
  }
